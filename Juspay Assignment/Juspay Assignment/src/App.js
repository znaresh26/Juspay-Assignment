...
import PreviewArea from "./components/Viewstate";
    ...
    <div className="bg-blue-100 font-sans">
      <div className="h-screen  overflow-hidden flex flex-row pt-6">
        <DragDropContext onDragEnd={onDragEnd}>
          <div className="flex-1 h-screen overflow-hidden flex flex-row bg-blue-900 border-t border-r border-gray-200 rounded-tr-xl mr-2">
            <Sidebar />
            <MidArea />
          </div>
